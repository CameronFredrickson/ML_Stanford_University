...
alpha = 0.3; % starting value of 0.01
num_iters = 100; % originally 400
...
[theta3, J_history3] = gradientDescentMulti(X, y, theta3, 1, num_iters);
...
legend('alpha = 0.3', 'alpha = 0.01', 'alpha = 1');
...
House = [1 ((1650 - mu(:, 1)) / sigma(:, 1)) ((3 - mu(:, 2)) / sigma(:, 2))];
